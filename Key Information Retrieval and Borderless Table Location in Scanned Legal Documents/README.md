...
This repository contains the source code and documentation for my Master's Thesis, conducted at the **Athens University of Economics and Business (AUEB)** in collaboration with the LegalTech company **Cognitiv+**.
